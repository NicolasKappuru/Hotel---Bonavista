...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.stack.addWidget(self.vista_recepcion_home)  # index 0
        self.stack.addWidget(self.vista_cliente_insert)    # index 1
        self.stack.addWidget(self.vista_cliente_update)
        self.stack.addWidget(self.vista_reservas)        # index 2
        self.stack.addWidget(self.vista_disponibilidad)  # index 3
